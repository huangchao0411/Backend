...
public class ProcessEntity {
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof ProcessEntity)) {
            return false;
        } else {
    ...
    public ProcessEntity(Integer id, String title, String name, String content, String img, Short isShow, Short sortID, LocalDateTime addTime, LocalDateTime updateTime) {
        this.id = id;
        this.title = title;
        this.name = name;
