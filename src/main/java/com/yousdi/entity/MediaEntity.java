...
public class MediaEntity {
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof MediaEntity)) {
            return false;
        } else {
    ...
    public MediaEntity(Integer id, String name, String url, String img, Integer isShow, Integer sortID, LocalDateTime updateTime, LocalDateTime addTime, Integer isShare) {
        this.id = id;
        this.name = name;
        this.url = url;
        this.img = img;
